...
if __name__ == "__main__":
    ...
    for comments in post.comments.list():
        input_text = comments.body
        custom_tokens = remove_noise(word_tokenize(input_text))
        print(input_text, classifier.classify(dict([token, True] for token in custom_tokens)))
